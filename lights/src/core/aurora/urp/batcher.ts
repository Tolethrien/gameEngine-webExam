...
import radial from "../../../assets/lights/radial.png";
import radialHalf from "../../../assets/lights/radial_half.png";
import spot from "../../../assets/lights/spotlight_free.png";
import spotStar from "../../../assets/lights/spotlight_star.png";
import star from "../../../assets/lights/star.png";
import wide from "../../../assets/lights/wide.png";
...
export default class Batcher {
  ...
  private static async createBatcherTextures() {
    ...
    await AuroraTexture.createTextureArray({
      label: "lightsList",
      textures: [
        { name: "radial", url: radial },
        { name: "radialHalf", url: radialHalf },
        { name: "spot", url: spot },
        { name: "spotStar", url: spotStar },
        { name: "star", url: star },
        { name: "wide", url: wide },
      ],
    });
